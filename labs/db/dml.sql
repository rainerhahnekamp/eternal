...
insert into HolidayTrip(FromDate, ToDate, PriceSingleRoom, PriceDoubleRoom, Currency, GuideId, HolidayId) values('2023-04-12', '2023-04-25', 4210, 3899, 'EUR', 2, 2);

insert into HolidayTrip(FromDate, ToDate, PriceSingleRoom, PriceDoubleRoom, Currency, GuideId, HolidayId) values('2023-10-20', '2023-11-02', 3912, 3459, 'EUR', 2, 2);

insert into HolidayTrip(FromDate, ToDate, PriceSingleRoom, PriceDoubleRoom, Currency, GuideId, HolidayId) values('2023-07-15', '2023-07-30', 6500, 5399, 'EUR', 1, 1);

...
@Component({
  ...
  template: `<h2 data-testid="greeting">Welcome to Eternal</h2>
    <button mat-raised-button (click)="toggleClick()">{{ clicked() ? 'Unclick me' : 'Click me' }}</button>
<!--  <button mat-raised-button *ngIf="!clicked()" (click)="toggleClick()">Click me</button>-->
<!--  <button mat-raised-button *ngIf="clicked()" (click)="toggleClick()">Unclick me</button>-->

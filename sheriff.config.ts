...
export const sheriffConfig: SheriffConfig = {
  ...
  modules: {
    ...
    'ngrx-signals': ['shared', 'shared:ngrx'],
    'ngrx-signals/entities': ['shared', 'shared:ngrx'],
    'ngrx-signals/events': ['shared', 'shared:ngrx'],
    'ngrx-signals/rxjs-interop': ['shared', 'shared:ngrx'],
    'ngrx-signals/testing': ['shared', 'shared:ngrx'],
  },
  depRules: {
    ...
    'shared:security': ['shared:http', 'shared:ngrx'],
